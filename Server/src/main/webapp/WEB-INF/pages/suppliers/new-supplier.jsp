...
<div class="row">
<form:form id="addSupplierForm" method="POST" action="add/supplier" commandName="supplier" role="form">
<div class="col-lg-6">
...
<div class="col-lg-6">
    ...
    <div class="form-group">
        ...
        <form:select path="IVACondition" class="form-control" items="${conditions}"/>
    ...
    <div class="form-group">
        ...
        <div class="form-group input-group" style="margin-bottom: 0px;">
            <form:input path="credit" value="0" class="form-control currency" placeholder="0.00 $"/>
            <span class="input-group-addon"><i class="fa fa-money"></i></span>
        </div>
        <p class="help-block">Maximo valor de deuda que se le puede mantener.</p>
    </div>
        <%--<div class="form-group">--%>
        ...
        <%--</c:if>--%>
        <%--</select>--%>
        <%--<p class="help-block">Lista de precios para el proveedor.</p>--%>
        <%--</div>--%>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <label class="radio-inline"><form:radiobutton path="supplierType" value="0"/>M</label>
        <label class="radio-inline"><form:radiobutton path="supplierType" value="1"/>5</label>
        <label class="radio-inline"><form:radiobutton path="supplierType" value="2"/>1</label>
    </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table id="contacts" class="table table-striped table-hover">
                    ...
                    <tbody>
                    <c:if test="${not empty supplier.contacts}">
                        <c:forEach var="contact" items="${supplier.contacts}" varStatus="status">
                            <tr>
                                <td>${contact.name}</td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" id="addContactButton">Agregar Contacto
                            </button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
    ...
    <button type="button" id="addSupplierButton" class="btn btn-primary">${actionButtonLabel}</button>
    <button type="reset" id="cleanAddSupplierForm" class="btn btn-default">Limpiar</button>
</div>
<!-- /.col-lg-6 (nested) -->
<form:hidden path="id"/>
<c:if test="${not empty supplier.contacts}">
...
<tiles:putAttribute name="page-controller">
    <script src="js/controllers/supplier/newSupplierPageController.js"></script>
</tiles:putAttribute>
