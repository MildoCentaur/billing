function NewClientPageController(){
    ...
    this._initializeAddClientFormPage= function(){
        ...
        $("#addClientButton").css("float","right");
        $("#addClientButton").css("margin-left","10px");
        $("#cleanAddClientForm").css("float","right");
        $("#cleanAddClientForm").css("margin-left","10px");

        $("#addClientButton").click(function(){ pageController.addClientButtonAction(); });
        $("#addStoreButton").click(function(){ pageController.addStoreButtonAction(); });
        $("#addContactButton").click(function(){ pageController.addContactButtonAction(); });
    ...
    this._validateNewClientContact= function(){
        var result = true;
    ...
    this._validateNewClientForm= function(){
        ...
        bValid = $("#addressDelivery").val()=="" || isValidAlphaNumeric( $("#addressDelivery").val());
        result = bValid && result;
        if(!bValid){
...
NewClientPageController.prototype = Object.create(PageController.prototype); // See note below

// Set the "constructor" property to refer to Student
NewClientPageController.prototype.constructor = NewClientPageController;

NewClientPageController.prototype.initialize = function(){
    this.initializePage();
    this._initializeAddClientFormPage();
    //this._listingAdjustments();

};
NewClientPageController.prototype.addClientButtonAction = function(){
    var form = $('#addClientForm');
    form.find("input").css("border","1px solid #ccc");
    var isValidClient = this._validateNewClientForm();
    ...
    if(isValidClient){
        ...
        this.doPost(form.attr('action'),form.serialize(),function(){
            location.href='list-clients.html';
        });
...
NewClientPageController.prototype.addContactButtonAction = function(){
    var modal = $("#addContactsModal");
    modal.find("input").css("border","1px solid #ccc");
    var isValid = this._validateNewClientContact();
    if(!isValid){
        return;
    }
...
NewClientPageController.prototype.addStoreButtonAction = function(){
...
var pageController = new NewClientPageController();
