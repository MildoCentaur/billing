function ListSellTaxationPageController() {
...
ListSellTaxationPageController.prototype = Object.create(PageController.prototype); // See note below

// Set the "constructor" property to refer to Student
ListSellTaxationPageController.prototype.constructor = ListSellTaxationPageController;

ListSellTaxationPageController.prototype.initialize = function () {
    this.initializePage();
    this._initializeListing();

};

var pageController = new ListSellTaxationPageController();
