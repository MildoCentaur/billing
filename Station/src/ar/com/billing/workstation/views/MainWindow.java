...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void pedidosMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pedidosMenuActionPerformed
        Date date = new Date();
        System.out.println("empezo a las " + date.getTime());
        clearAllElements();
        tituloLbl.setText("Pedidos para preparar");
        pedidoPanel.setVisible(true);
        Date finish = new Date();
        System.out.println("termino a las " + finish.getTime());
        System.out.println("pasaron " + (finish.getTime()-date.getTime())/1000);
